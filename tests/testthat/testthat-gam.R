# This script contains unit tests for the two independent Additive GAM functions.
# It assumes that the functions `design_rmst_gam_power` and `design_rmst_gam_ss`
# have been loaded into the environment (e.g., via devtools::load_all()).

# --- SETUP: Create synthetic pilot datasets for various scenarios ---
