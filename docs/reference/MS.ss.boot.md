...
#> Model: log(pseudo_obs) ~ region + region:arm
#> --- Searching for Sample Size (Method: Multiplicative Stratified RMST Model) ---
#>   N = 100/stratum, Calculating Power... Power = 0
#>   N = 150/stratum, Calculating Power... Power = 0
#>   N = 200/stratum, Calculating Power... Power = 0
#> Warning: Search terminated due to stagnation. Best N = 100 with power = 0
#> Total simulation time: 178.75 seconds
#> 
#> --- Simulation Summary ---
#> No valid estimates were generated to create a summary.
