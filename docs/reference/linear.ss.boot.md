...
#> Model: Y_rmst ~ arm
#> 
#> --- Searching for N for 80% Power ---
#>   N = 100/arm, Calculated Power = 0.925
#> Success: Target power reached at N = 100/arm.
#> Total simulation time: 0.69 seconds
#> 
#> --- Simulation Summary ---
#> 
#> 
...
#> |Statistic            |     Value|
#> |:--------------------|---------:|
#> |Mean RMST Difference | 1.7844698|
#> |Mean Standard Error  | 0.5216273|
#> |95% CI Lower         | 0.7292851|
#> |95% CI Upper         | 2.8396545|
