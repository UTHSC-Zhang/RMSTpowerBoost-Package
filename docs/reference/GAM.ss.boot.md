...
power reaches `target_power` or a stopping rule is met. At each step it
runs the same bootstrap procedure described in `GAM.power.boot`.
...
#> Model: pseudo_obs ~ arm
#>   N = 100/arm, Calculating Power... Power = 0.94
#> Success: Target power reached at N = 100/arm.
#> Total simulation time: 19.89 seconds
#> 
#> --- Simulation Summary ---
#> 
#> 
...
#> |Statistic            |     Value|
#> |:--------------------|---------:|
#> |Mean RMST Difference | 2.7453092|
#> |Mean Standard Error  | 0.7675185|
#> |95% CI Lower         | 1.3124725|
#> |95% CI Upper         | 4.1781458|
print(ss_results$results_data)
#>   Target_Power Required_N_per_Group
#> 1          0.8                  100
