rmst.multiplicative,power <- function(pilot_data, time_var, status_var, arm_var, strata_var,
   ...
   # Model for censoring (stratified by strata_var) [cite: 383, 386]
   ...
   # Calculate IPCW weights [cite: 382]
...
rmst.multiplicative.ss <- function(pilot_data, time_var, status_var, arm_var, strata_var,
